        ...
        return <div className='py-2 px-4 h-full w-full'>
            <MapComponent
                markerList={[
                    {
                        key: 'bus',
                        location: { lat: 52.19566102463737, long: -2.2203824104736944 },
                        content: beachFlagImg
                    }
                ]}
                polylinePath={[
                    { lat: 52.19566102463737, long: -2.2203824104736944 },
                    { lat: 52.19566102463737, long: -2.2893824104736944 },
                    { lat: 52.19566102463737, long: -2.2003824104736944 },
                    { lat: 52.1180102463737, long: -2.1903824104736944 }
                ]}
                polylineOptions={{
                    strokeColor: '#5193F9',
                    strokeWeight: 8
